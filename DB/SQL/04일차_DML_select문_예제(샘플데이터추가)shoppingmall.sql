...
insert into product_category(pc_num, pc_name)
	values(1,'가전'),(2,'의류'),(3,'식품'),(4,'취미용품'),(5,'애견용품');
...
insert into product(pr_pc_num, pr_title, pr_contents, pr_amount, pr_price)
	values(1,'50인치 TV','50인치 TV 팜',10,10000),
		  (1,'100인치 TV','100인치 TV 팜',20,100000),
		  (1,'무풍 에어컨','무풍 에어컨 팜',30,200000),
          (2,'셔츠','겨울용 셔츠 팜',15,1000),
          (3,'스테이크','부드러운 스테이크 팜',40,2000),
          (4,'등산화','안전한 등산화',5,5000),
          (5,'개껌','오래가는 개껌',3,10000);
...
-- buy 테이블 - insert문
insert into 
	buy(bu_num, bu_state, bu_amount, bu_address, 
    bu_post_num, bu_me_id, bu_pr_num)
	values('abc1', '결제완료', 1, '서울시 강남', '12345', 'abc', 1);
