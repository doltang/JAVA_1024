...
public class StudentManager {
	...
	public static void main(String[] args) {
		...
		try {
			...
			studentDao = new StudentDAOImp(sm.conn);
			int menu = -1;
			do{				
				printMenu();
				menu = sc.nextInt();
	...
	private static void updateStudent() {
		...
		StudentVO1 std = new StudentVO1(st_num, st_name, st_semester,
				st_state, st_pr_num);
	...
	private static void insertStudent() {
		...
		if(studentDao.insertStudent(new StudentVO1(st_num, st_name, st_semester, 
				st_state, st_pr_num)))
