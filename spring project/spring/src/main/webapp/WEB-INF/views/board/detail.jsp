...
<div class="container">
	<h1>게시글 확인</h1>
		...
		<div class="form-group">
			<label>제목:</label>
			<div class="form-control" id="title" name="bo_title">${board.bo_title}</div>
		</div>
			<div class="form-group">
			<label>작성자:</label>
			<div class="form-control" id="title" name="bo_title">${board.bo_me_id}</div>
		</div>
			<div class="form-group">
			<label for="title">작성일:</label>
			<div type="text" class="form-control" id="title" name="bo_title">${board.bo_register_date}</div>
		</div>
			<div class="form-group">
		...
		<c:if test="${board.bt_type == '일반' }">
			<div id="common">
				...
				<c:if test="${files.size() != 0 }">
					<div id="content" name="bo_content"></div>
